...
const AddQuiz = () => {
  ...
  return (
    <section className="flex justify-center align-middle w-screen h-screen bg-white mt-24 pt-4 ">
      {/* OLD FORM */}
      <article className="flex flex-col w-screen h-screen overflow-hidden">
        <div className="w-full bg-blue-400  text-center">
          <h1 className="m-6 text-3xl font-bold text-white">Add Quiz</h1>
        </div>
        <QuizForm
